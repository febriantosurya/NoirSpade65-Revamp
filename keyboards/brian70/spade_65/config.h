...
#define HS_RGB_INDICATOR_COUNT              84
#define HS_RGB_BAT_COUNT                    1

/* Device Name Definition */
#define MD_BT1_NAME "SDNBrian_Spade_65_1"
#define MD_BT2_NAME "SDNBrian_Spade_65_2"
#define MD_BT3_NAME "SDNBrian_Spade_65_3"
#define MD_DONGLE_MANUFACTURER "L67-2.4G Dongle"                     

/* Device Connection RGB Indicator Light Index And Color */
#define HS_RGB_BLINK_INDEX_BT1 44
#define HS_RGB_BLINK_INDEX_BT2 43 
#define HS_RGB_BLINK_INDEX_BT3 42 
#define HS_RGB_BLINK_INDEX_2G4 35 
#define HS_RGB_BLINK_INDEX_USB 40
...
/* Wireless serial message queue size.
 * Lowercase key = 4 packets, Shifted/special key = 8 packets.
 * 200 supports macros up to ~24 shifted chars or ~49 plain chars — but it will flood the ram*/
#define SMSG_NUM 64
