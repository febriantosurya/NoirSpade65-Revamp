...
void md_devs_change(uint8_t devs, bool reset) {
    ...
    switch (devs) {
        ...
        case DEVS_BT1: {
            ...
            if (reset) {
                md_send_manufacturer(MANUFACTURER, strlen(MANUFACTURER));
                md_send_product(MD_BT1_NAME, strlen(MD_BT1_NAME));
                md_send_vpid(VENDOR_ID, PRODUCT_ID);
                md_send_devctrl(MD_SND_CMD_DEVCTRL_CLEAN);
                md_send_devctrl(MD_SND_CMD_DEVCTRL_PAIR);
            }
        ...
        case DEVS_BT2: {
            ...
            if (reset) {
                md_send_manufacturer(MANUFACTURER, strlen(MANUFACTURER));
                md_send_product(MD_BT2_NAME, strlen(MD_BT2_NAME));
                md_send_vpid(VENDOR_ID, PRODUCT_ID);
                md_send_devctrl(MD_SND_CMD_DEVCTRL_CLEAN);
                md_send_devctrl(MD_SND_CMD_DEVCTRL_PAIR);
            }
        ...
        case DEVS_BT3: {
            ...
            if (reset) {
                md_send_manufacturer(MANUFACTURER, strlen(MANUFACTURER));
                md_send_product(MD_BT3_NAME, strlen(MD_BT3_NAME));
                md_send_vpid(VENDOR_ID, PRODUCT_ID);
                md_send_devctrl(MD_SND_CMD_DEVCTRL_CLEAN);
                md_send_devctrl(MD_SND_CMD_DEVCTRL_PAIR);
            }
