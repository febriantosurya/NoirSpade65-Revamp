...
void __attribute__((weak)) rgblight_set(void) {
    if (!rgblight_config.enable) {
        for (uint8_t i = rgblight_ranges.effect_start_pos; i < rgblight_ranges.effect_end_pos; i++) {
...
void __attribute__((weak)) rgblight_effect_breathing(animation_status_t *anim) {
...
void __attribute__((weak)) rgblight_effect_rainbow_mood(animation_status_t *anim) {
